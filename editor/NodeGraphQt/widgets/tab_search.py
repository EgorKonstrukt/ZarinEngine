...
from editor.NodeGraphQt.constants import ViewerEnum, ViewerNavEnum
...
class TabSearchCompleter(QtWidgets.QCompleter):
    ...
    def updateModel(self):
        ...
        pattern = QtCore.QRegularExpression(self._local_completion_prefix,
                                 QtCore.QRegularExpression.PatternOption.CaseInsensitiveOption)
        self._filter_model.setFilterRegularExpression(pattern)
