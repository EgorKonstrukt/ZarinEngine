...
from editor.NodeGraphQt.compat import QUndoCommand, QUndoStack

from editor.NodeGraphQt.base.commands import (NodeAddedCmd, NodeMovedCmd,
                                       NodesRemovedCmd, PortConnectedCmd)
from editor.NodeGraphQt.base.factory import NodeFactory
from editor.NodeGraphQt.base.menu import NodeGraphMenu, NodesMenu
from editor.NodeGraphQt.base.model import NodeGraphModel
from editor.NodeGraphQt.base.node import NodeObject
from editor.NodeGraphQt.base.port import Port
from editor.NodeGraphQt.constants import (MIME_TYPE, URI_SCHEME, URN_SCHEME,
                                   LayoutDirectionEnum, PipeLayoutEnum,
                                   PortTypeEnum, ViewerEnum)
from editor.NodeGraphQt.errors import NodeCreationError, NodeDeletionError
from editor.NodeGraphQt.nodes.backdrop_node import BackdropNode
from editor.NodeGraphQt.nodes.base_node import BaseNode
from editor.NodeGraphQt.nodes.group_node import GroupNode
from editor.NodeGraphQt.nodes.port_node import PortInputNode, PortOutputNode
from editor.NodeGraphQt.widgets.node_graph import NodeGraphWidget, SubGraphWidget
from editor.NodeGraphQt.widgets.viewer import NodeViewer
from editor.NodeGraphQt.widgets.viewer_nav import NodeNavigationWidget
...
class NodeGraph(QtCore.QObject):
    ...
    """
    data_dropped = Signal(QtCore.QMimeData, QtCore.QPoint)
    """
    ...
    def clear(self):
        """
        Alias for clear_session. Removes all nodes from the graph.
        """
        self.clear_session()
