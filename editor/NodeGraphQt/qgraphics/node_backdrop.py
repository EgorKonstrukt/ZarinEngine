...
from editor.NodeGraphQt.constants import Z_VAL_BACKDROP, NodeEnum
from editor.NodeGraphQt.qgraphics.node_abstract import AbstractNodeItem
from editor.NodeGraphQt.qgraphics.pipe import PipeItem
...
class BackdropNodeItem(AbstractNodeItem):
    ...
    def get_nodes(self, inc_intersects=False):
        mode = {True: QtCore.Qt.ItemFlag.IntersectsItemShape,
                False: QtCore.Qt.ItemFlag.ContainsItemShape}
        nodes = []
        if self.scene():
