...
class TextRenderer(Component):
    ...
    def _inspector_fields(cls) -> list[InspectorField]:
        return [
            InspectorField("", "Text", FieldType.HEADER),
            ...
            InspectorField("", "Style", FieldType.HEADER),
            ...
            InspectorField("", "Shadow", FieldType.HEADER),
            ...
            InspectorField("", "Outline", FieldType.HEADER),
            ...
            InspectorField("", "Glow", FieldType.HEADER),
            ...
            InspectorField("", "3D", FieldType.HEADER),
